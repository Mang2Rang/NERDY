...
CREATE TABLE `purchase` (
  ...
  KEY `FK39otdgknc3fc9n7nfes0mxtf9` (`item_id`),
  CONSTRAINT `FK39otdgknc3fc9n7nfes0mxtf9` FOREIGN KEY (`item_id`) REFERENCES `bestitem` (`id`),
...
-- Dump completed on 2023-12-05 20:15:59
